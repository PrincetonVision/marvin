...
Marvin's life depends on an NVIDIA GPU with [CUDA 7.5](http://lmgtfy.com/?q=install+cuda+7.5) and [cuDNN 5rc](http://lmgtfy.com/?q=install+cuDNN+5). See the [README](https://github.com/PrincetonVision/marvin) for more details on path wrangling.
