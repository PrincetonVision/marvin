...
int main(int argc, char **argv){
	...
	if (argc < 3 || argc >10){
		...
		cout<<"       example: "<<argv[0]<<" train mnist/lenet.json"<<endl;
		...
		cout<<"       example: "<<argv[0]<<" test mnist/lenet.json ip1,conv2 mnist/ip1.tensor,mnist/conv2.tensor"<<endl;
		...
		cout<<"       example: "<<argv[0]<<" activate mnist/lenet.json mnist/lenet.marvin data conv1,conv2 [0,1,2],[0,1,2,3,4,5] mnist/filters_ 100 20"<<endl;
		return 0;
